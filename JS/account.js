...
function register()
{
  $("#btn_register").click(function ()
  {
    ...
    if ($("#ho").val() == "")
    {
      ...
      $("#ho").attr("placeholder", "Nhập họ của bạn !");
    ...
    if ($("#password_register_retype").val() == "")
    {
      $("#password_register_retype").addClass("PaymentError");
      $("#password_register_retype").attr("placeholder", "Nhập mật khẩu của bạn !");
      $("#password_register_retype").mouseenter(function ()
      {
        $("#password_register_retype").removeClass("PaymentError");
        $("#password_register_retype").attr("placeholder", "Xác nhận mật khẩu");
      });
    }
  });
}
